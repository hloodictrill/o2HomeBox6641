...
#ifdef TELEFONICA
	/* __MTS__, Amy, merge from Telefonica P-870HNU-51B(102BKW0) Revision#5102, #5106, #5110
	[Work Around] Clear the ctinfo if CPE does not receive ICMP Reply over 2 times. __TELEFONICA__, MitraStar, Stan Su, 20111018. */
	if (ct->proto.icmp.count.counter > 2)
	{
