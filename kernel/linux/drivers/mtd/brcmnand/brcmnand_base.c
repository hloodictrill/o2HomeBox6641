...
#endif /*CONFIG_BRCMNAND_USE_HW_SEMAPHORE*/
...
static int brcmnand_probe(struct mtd_info *mtd, unsigned int chipSelect)
{
	...
	/*------------- 3rd ID byte --------------------*/	
	#if !defined(CONFIG_MIPS_BRCM)	/*ChenHe@MSTC for support spansion NAND flash*/
	...
	#else	/*ChenHe@MSTC for support spansion NAND flash*/
		if (foundInIdTable) {
	#endif	/*ChenHe@MSTC for support spansion NAND flash*/
