...
/*__MTS__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11*/
#ifdef MTS_NAND_FLASH_SUPPORT
#ifdef CONFIG_BUILD_MSTC_FWUP_FROM_FLASH /* MSTC_FWUP_FROM_FLASH, MSTC modified for Telefonica Chile */
...
#else
        nandinfo->nr_parts = 3;
#endif /*CONFIG_BUILD_MSTC_FWUP_FROM_FLASH*/
#else /*MTS_NAND_FLASH_SUPPORT*/
        nandinfo->nr_parts = 4;
#endif /*MTS_NAND_FLASH_SUPPORT*/
        nandinfo->parts = bcm63XX_nand_parts;
...
/*__MTS__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11*/
        ...
        /* __CHT__, MitraStar Curtis, 20111124. */
