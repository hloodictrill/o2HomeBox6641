...
/*MSTC , rewrite "RaynorChung: Ssupport USB LED " to compiler flag by Andylin 20120521*/
	...
	ZyXEL_USB_LED_Control( udev->portnum, 0x00 );
#endif
...
/* USB mass storage mount fails at boot time if the mounting point is too early, __TELEFONICA__, Mitrastar Eva, 20110623. */
#ifdef TELEFONICA	
