...
/*KeyYang@MSTC: Merge from Telefonica_Common, 20120710*/
	...
	/* Indicate this ct is created by RTSP helper, regardless_drop will ignore it. */
	IPS_SKIP_REGARDLESS_DROP_BIT = 12,
	IPS_SKIP_REGARDLESS_DROP = (1 << IPS_SKIP_REGARDLESS_DROP_BIT),
#endif /*TELEFONICA*/
