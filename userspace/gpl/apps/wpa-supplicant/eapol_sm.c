...
#if 1//__MTS__, Amy, 802.1x for cms
...
extern void send8021XEventMessage(int authStatus, const char *paeState);//__MTS__, Amy, 802.1x for cms
...
SM_STATE(SUPP_PAE, LOGOFF)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Logoff");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, DISCONNECTED)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Disconnected");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, CONNECTING)
{
	...
	if (send_start)
		eapol_sm_txStart(sm);
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Connecting");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, AUTHENTICATING)
{
	...
	sm->keyDone = FALSE;
	sm->suppStart = TRUE;
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Authenticating");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, HELD)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Held");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, AUTHENTICATED)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Authenticated");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, RESTART)
{
	...
	sm->eapRestart = TRUE;
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Restart");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, S_FORCE_AUTH)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "ForceAuth");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, S_FORCE_UNAUTH)
{
	...
	eapol_sm_txLogoff(sm);
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "ForceUnauth");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_BE, SUCCESS)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_SUCCESS, "");//__MTS__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_BE, FAIL)
{
	...
	sm->suppFail = TRUE;
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "");//__MTS__, Amy, 802.1x for cms
}
