...
#ifdef BUILD_MTS_QoS
/*__MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trun*/
...
/*KeyYang@MSTC: Merge from Telefonica_Common, 20120712*/
#ifdef BUILD_MTS_QoS
			/*__MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk*/
			print_iface(hlp->in); 
#else
			printf("%s ", hlp->in);
#endif /*BUILD_MTS_QoS*/
...
#ifdef BUILD_MTS_QoS
			/*__MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk*/
			print_iface(hlp->logical_in); // __MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk
#else
...
#ifdef BUILD_MTS_QoS
			/*__MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk*/
			print_iface(hlp->logical_out); // __MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk
#else
...
#ifdef BUILD_MTS_QoS
			/*__MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk*/
			print_iface(hlp->out); // __MTS__, Paul Ho, for MBSSID/LAN Isolation, Merged from 406 common trunk
#else
			printf("%s ", hlp->out);
#endif /*BUILD_MTS_QoS*/
		}
