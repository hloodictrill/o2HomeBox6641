...
/* Ranges expected in network order. *//*KeyYang@MSTC: Merge from Telefonica_Common, 20120712*/
#ifdef MSTC_TELEFONICA_CUSTOMIZATION
/* merge from DSL-401HNU-B1B_V2 by Andylin
Support one-to-one port mapping. __TELEFONICA__, MSTC Stan Su, 20120308 */
