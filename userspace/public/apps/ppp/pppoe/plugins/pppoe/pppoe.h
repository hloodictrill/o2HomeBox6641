...
#ifdef MSTC_TO2_GERMANY_CUSTOMIZATION /*__MSTC__, chris 2012-11-20*/
extern int identifyServiceMode(char *ac_name);
extern void sendPPPoEDiscoverEventMessage(UBOOL8 bDscChng, char *serviceMode);
extern UBOOL8 startNetDiscovery();
#endif 
...
#ifdef POE_FATAL_DEBUG /* Fix PPPoE does not reconnect in some fatal conditions. 
                          We think pppd should show the robustness no matter what packet it received. 
                          Therefore, we change poe_fatal() function to do nothing to help pppd reconnect at this case, 
                          __TELEFONICA__, ZyXEL YungAn, 20100427. */
