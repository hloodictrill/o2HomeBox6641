...
void CleanTraces()
{
	AllocRecord *allocRec=NULL, *allocRec2=NULL, *tmpRec=NULL;
	...
	dlist_for_each_entry(allocRec, &glbAllocRec, dlist)
	{
      ...
      while (((DlistNode *) allocRec2) != &glbAllocRec)
      {   
	  	  tmpRec= (AllocRecord *)allocRec2->dlist.next;		  		  
		  dlist_unlink(allocRec2);
		  free(allocRec2);
		  
		  allocRec2 = (AllocRecord *) tmpRec;
      }	 
	}
	printf("==== Finish clean All trace record ====\n");
}
#endif /*MSTC_COMMON_PATCH*/
