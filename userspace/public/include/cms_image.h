...
/*[IreneWang@MSTC:TO2]$ Partial configuration and restore, 20121227*/
    ...
    CMS_IMAGE_FORMAT_ACSXML_CFG=7,	/**< Partial Reset for ACS XML config file */
    CMS_IMAGE_FORMAT_GUIXML_CFG=8,	/**< Partial Reset for GUI XML config file*/
    CMS_IMAGE_FORMAT_AREAXML_CFG=9,	/**< Partial Reset for Area Detection XML config file*/
#endif  /*MSTC_TO2_GERMANY_CUSTOMIZATION*/
    
    CMS_IMAGE_FORMAT_PART1=0x10,   /**< Specify to write to partition1 */
    CMS_IMAGE_FORMAT_CSV_CFG=11,   /**< for phonebook import supported */
...
#if 1 //LingChun
#define CMS_CONFIG_FILE_MAXIMUM_LENGTH 1000000
#endif
...
/** Send a clean call List msg to smd.
 * 
 * @param msgHandle (IN) the message handle to use to send the message.
 */
void cmsUtil_sendCleanCallQuaMsg(void *msgHandle);

/** Send a clean call Quaity msg to smd.
 * 
 * @param msgHandle (IN) the message handle to use to send the message.
 */
...
#ifdef MSTC_TO2_GERMANY_CUSTOMIZATION	/*Jayden added for disable bspl led control,MitraStar,20131112*/
