...
#if defined(BRCM_VOICE_BOARD_ID)
#define VOICECFG_DEFAULT_BOARD_ID BRCM_VOICE_BOARD_ID
#else
#define VOICECFG_DEFAULT_BOARD_ID VOICECFG_SI32261_STR
#endif
...
VOICE_BOARD_PARMS voiceBoard_963168FTTH_LE89116 =
{
   VOICECFG_LE89116_STR,   /* szBoardId */
   "963168FTTH",   
   2,             /* numFxsLines */
...
/*Jayden@MSTC modify for taking off BUILD_5G featrue*/
#if 1 
VOICE_BOARD_PARMS voiceBoard_963168VXHPNA_LE89116 =
{
   VOICECFG_LE89116_STR,   /* szBoardId */
   "963168VXHPNA",   
   2,             /* numFxsLines */
...
VOICE_BOARD_PARMS voiceBoard_963168VX5G_LE89116 =
{
   VOICECFG_LE89116_STR,   /* szBoardId */
   "963168VX5G",   
   2,             /* numFxsLines */
...

   {
      /* voiceDevice0 parameters */
      {
         ...
         /* Channel description */
         {
            ...
            /* Null Channel on device */
            BP_NULL_CHANNEL_MACRO
            /* Null Channel on device */
            BP_NULL_CHANNEL_MACRO
         }
      },
...
VOICE_BOARD_PARMS voiceBoard_963168VXTo2_SI32260 =
{
   VOICECFG_SI32261_STR,   /* szBoardId */
   "963168VXTo2",
   2,             /* numFxsLines */
...
VOICE_BOARD_PARMS voiceBoard_963168VXTo2_1_SI32260 =
{
   VOICECFG_SI32261_STR,   /* szBoardId */
   "963168VXTo2_1",
   2,             /* numFxsLines */
...
VOICE_BOARD_PARMS voiceBoard_963168FTTH5G_LE89116 =
{
   VOICECFG_LE89116_STR,   /* szBoardId */
   "963168FTTH5G",   
   2,             /* numFxsLines */
...
static PVOICE_BOARD_PARMS g_VoiceBoardParms[] = 
{
   ...
   &voiceBoard_963168FTTH_LE89116,
   &voiceBoard_963168VX5G_LE89116,
   &voiceBoard_963168VXTo2_SI32260,
   &voiceBoard_963168VXTo2_1_SI32260,
   &voiceBoard_963168FTTH5G_LE89116,
...
#if DBG_Gino
   printk ("\n\n\n>>GinoDebug<<BpGetVoiceParms pszBoardId=%s, pszBaseBoardId=%s\n",pszBoardId, pszBaseBoardId);
#endif


   for( ppBp = g_VoiceBoardParms; *ppBp; ppBp++ )
   {
     if( (0 == bpstrcmp((*ppBp)->szBoardId, VOICECFG_DEFAULT_BOARD_ID)) && (0 == bpstrcmp((*ppBp)->szBaseBoardId, pszBaseBoardId) ))
     {
...
#if DBG_Gino
//	printk ("\n\n\n>>GinoDebug<< BpSetVoiceBoardId: pszBoardId=%s\n",pszBoardId);
	printk ("\n\n\n>>GinoDebug<< BpSetVoiceBoardId: ENTER\n");

if (g_VoiceBoardParms==NULL)
{
	printk ("\n\n\n>>GinoDebug<< BpSetVoiceBoardId: NULL NULL\n");
}else
{
	printk ("\n\n\n>>GinoDebug<< BpSetVoiceBoardId: NOT NOT NOT NULL\n");
}
#endif
    ...
    {
    	#if DBG_Gino
		printk ("\n\n\n>>GinoDebug<< BpSetVoiceBoardId: szBaseBoardId=%s, %s\n", (*ppBp)->szBaseBoardId, VOICECFG_DEFAULT_BOARD_ID);
		#endif
        if( 0 == bpstrcmp((*ppBp)->szBoardId, VOICECFG_DEFAULT_BOARD_ID) )
        {
            g_pCurrentVoiceBp = *ppBp;
            nRet = BP_SUCCESS;
            break;
...
#if DBG_Gino
	printk ("\n\n\n>>GinoDebug<<BpGetVoiceBoardId pszBoardId=%s\n",pszBoardId);
#endif
...
#if DBG_Gino
	printk ("\n\n\n>>GinoDebug<<BpGetVoiceBoardIds pszBoardIds=%s, pszBaseBoardId=%s\n",pszBoardIds, pszBaseBoardId);
#endif
