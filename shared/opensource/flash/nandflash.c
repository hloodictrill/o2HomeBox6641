...
#endif //end of #ifdef _CFE_
#else //__MTS__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
#include "lib_types.h"
#include "lib_printf.h"
#include "lib_string.h"
#include "lib_malloc.h"
...
#include "cfe_timer.h"
#endif
#endif //end __MTS__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
...
#if 1 /*ChenHe@MSTC for support spansion NAND flash*/
...
#define NAND_FLASH_DEVICES                                                    \
  {{NAND_MAKE_ID(FLASHTYPE_SAMSUNG,SAMSUNG_K9F5608U0A),"Samsung K9F5608U0"},  \
   ...
   {NAND_MAKE_ID(FLASHTYPE_TOSHIBA,TOSHIBA_TC58NVG0S3ETA00),"Toshiba TC58NVG0S3ETA00"},\
...
#if 1/* ChenHe@MSTC for BRCM NAND flash common bug fix CSP#605922 */
...
#if 0 /* ChenHe@MSTC for BRCM NAND flash common bug fix CSP#605922 */
...
static int nand_initialize_spare_area_for_SMT(PCFE_NAND_CHIP pchip)
{
    ...
    unsigned long i;
    int ret;
#ifdef MSTC_COMMON_PATCH /* __MSTC__, zongyue: want to skip BBT to prevent destory BBT signature */
