...
/* product depend define */
#define HW_5G_IAD	0
#define HW_HPNA_IAD	1
#define HW_PURE_IAD	2

#define BP_5G_HPNA_PHY_ID                      (4)
/* End product depend define */
#endif
...
#if 1 /* MSTC_TO2_GERMANY_CUSTOMIZATION */ /* 20120906 added by Jayden for LED control */
...
int BpGetDECTAnmeldenGpio( unsigned short *pusValue );
int BpGetDECTPagingGpio( unsigned short *pusValue );

#ifdef BUILD_MSTC_FW_WITH_DIFFERENT_HW
int BpGetHWType(void);
